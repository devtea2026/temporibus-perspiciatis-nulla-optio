...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@devtea2026/temporibus-perspiciatis-nulla-optio">
    <img alt="" src="https://img.shields.io/npm/v/@devtea2026/temporibus-perspiciatis-nulla-optio.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@devtea2026/temporibus-perspiciatis-nulla-optio.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@devtea2026/temporibus-perspiciatis-nulla-optio">
...
```bash
npm install @devtea2026/temporibus-perspiciatis-nulla-optio
```

Use with [Node.js](https://nodejs.org/en/), [Browserify](https://browserify.org/), or [webpack](https://webpack.github.io/):

```js
const classNames = require('@devtea2026/temporibus-perspiciatis-nulla-optio');
...
There is also a [Changelog](https://github.com/devtea2026/temporibus-perspiciatis-nulla-optio/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@devtea2026/temporibus-perspiciatis-nulla-optio';
...
```js
const classNames = require('@devtea2026/temporibus-perspiciatis-nulla-optio/dedupe');
...
```js
const classNames = require('@devtea2026/temporibus-perspiciatis-nulla-optio/bind');
...
import classNames from '@devtea2026/temporibus-perspiciatis-nulla-optio/bind';
